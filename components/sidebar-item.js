    ...
    return (
        <button className={`inline-flex flex-col ${active==page ? "font-bold" : ""} outline-0 w-full`} onClick={() => setPage(page)}>
            <span className='flex px-2'
                ...
                {text}
                <Transition show={(isHovering || active==page)} className='animate-fade-in-left animation-duration-200'
            ...
            <Transition show={active==page} className='flex space-x-1 md:space-x-2 w-full lg:w-3/4 animate-fade-in-left animation-duration-500'
            ...
            >
                <div className='grow bg-gradient-to-r from-blue-600 to-cyan-400 rounded-full h-3 animate-gradient-x'></div>
                <div className='bg-gradient-to-r from-cyan-400 to-blue-600 rounded-full w-3 h-3 animate-gradient-x'></div>
            </Transition>
        </button>
    )
}
