    ...
    return (
        ...
        >
            <div className='flex flex-col space-y-8 md:space-y-12 mb-16'>
                <div className='flex flex-col-reverse lg:flex-row items-center space-x-0 lg:space-x-8 space-y-4 space-y-reverse lg:space-y-0'>
                    ...
                    <div className='flex items-center flex-shrink-0 w-3/5 lg:w-1/4 mx-auto'>
