                ...
                <main className='flex flex-col content-center h-full pt-20'>
					<div className='grow text-gray-700 text-xs md:text-base w-full max-w-7xl mb-4 mx-auto px-4 lg:px-8 py-2 lg:py-4'>
						<div className={`flex flex-col-reverse lg:flex-row space-x-0 lg:space-x-4 space-y-4 space-y-reverse lg:space-y-0 w-full h-full`}>
                            {/* Main Content */}
                            <div className='flex flex-col rounded-2xl w-full px-4 sm:px-6 lg:px-8 py-4 md:py-8 z-40'>
								<div className='flex flex-col relative w-full animate-scale-big animation-duration-500'>
                            ...
                            <div className='flex flex-shrink-0 w-full lg:w-1/4 z-10'>
                                <div className='grid lg:flex grid-cols-3 lg:flex-col gap-2 lg:space-y-2 w-full lg:pl-8 py-4 lg:py-8'>
                                    ...
                                    <SidebarItem text="Projects" secondText="I've Done" page="projects" active={page} setPage={setPage} />
                                </div>
                            </div>
                        </div>
                    </div>
